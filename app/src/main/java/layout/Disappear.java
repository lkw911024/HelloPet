...
public class Disappear extends Fragment implements SwipeRefreshLayout.OnRefreshListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_disappear, container, false);


        // 실종/보호의 리사이클 뷰 연결
        recyclerView = (RecyclerView) v.findViewById(R.id.disappear_recycler_view);
    ...
    private ArrayList<SimpleReportVO> requestSimpleDisappearList(){
        ...
        reportList.add(new SimpleReportVO("2", "1", "경기도 광주시 초월읍 학동리", "2017-09-13", "박세훈 닮음ㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇㅇ", "강아지", "포메라니안", "삼순이", "암컷"));
        reportList.add(new SimpleReportVO("3", "1", "강원도 원주시 상지대학교", "2017-10-12", "이천우 닮음", "고양이", "고양이", "솜이", "암컷"));
        reportList.add(new SimpleReportVO("4", "1", "원주 시외버스 터미널", "2017-10-15", "김형근 닮음", "고양이", "고양이", "토리", "수컷"));
        reportList.add(new SimpleReportVO("5", "1", "서울 중랑구 면목동", "2017-10-24", "방지현 닮음", "강아지", "불독", "방지", "수컷"));
        reportList.add(new SimpleReportVO("6", "1", "서울 고속버스터미널", "2017-11-12", "민수 닮음", "고양이", "페르시안", "냐옹이", "수컷"));
